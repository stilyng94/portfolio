function Footer() {
  return (
    <footer
      id="contact"
      className="flex justify-center items-center flex-col h-auto text-center min-h-[70px] p-4"
    >
      <div className="block w-full max-w-xs mt-0 mx-auto mb-3">
